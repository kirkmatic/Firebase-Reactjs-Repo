  ...
  <>
    <section className="bg-red-50 bg-cover bg-center w-full min-h-screen px-8 py-16 flex flex-col items-center">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className="text-red-400 text-6xl font-['Montserrat'] font-extrabold mb-8">Our Services</h1>
        <p className="text-red-300 text-2xl font-['Montserrat'] font-medium mb-12">
